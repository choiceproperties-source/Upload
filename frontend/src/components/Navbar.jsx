                          ...
                          <div className="py-2">
                            <Link to="/profile" className="block">
                              <motion.div
                                ...
                                className="w-full px-6 py-3 text-left text-sm text-gray-700 hover:text-blue-600 flex items-center space-x-3 transition-colors cursor-pointer"
                              >
                            ...
                            {user?.isAdmin && (
                              <>
                                ...
                                <Link to="/admin" className="block">
                                  <motion.div
                                    whileHover={{ x: 4, backgroundColor: "rgb(243 244 246)" }}
                                    className="w-full px-6 py-3 text-left text-sm text-purple-600 hover:text-purple-700 flex items-center space-x-3 transition-colors cursor-pointer font-medium"
                                  >
