    ...
    >
      <div className="relative overflow-hidden aspect-w-16 aspect-h-9 bg-gradient-to-br from-blue-50 to-indigo-100">
        <ImageKitImage
          ...
          width={600}
          height={384}
          className="w-full h-64 transition-all duration-700 ease-out group-hover:scale-110 group-hover:brightness-110"
        />
          ...
          {isHovered && (
            ...
            >
              <button
                ...
                className="px-6 py-3 bg-white/95 backdrop-blur-sm text-emerald-600 rounded-full flex items-center gap-2 hover:bg-emerald-600 hover:text-white transition-all duration-300 font-semibold text-sm shadow-xl border border-white/50 group-hover:scale-105"
              >
