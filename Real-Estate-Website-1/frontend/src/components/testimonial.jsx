          ...
          <div className="relative group/avatar">
            ...
            >
              <ImageKitImage
                ...
                width={64}
                height={64}
                className="w-16 h-16 rounded-full border-3 border-white shadow-lg group-hover/avatar:shadow-xl transition-shadow duration-300"
                loading="lazy"
              />
        ...
        <div className="lg:hidden relative">
          ...
          <div className="flex justify-center items-center mt-12 space-x-6">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={handlePrev}
              className="group p-4 rounded-full bg-white/80 backdrop-blur-sm border border-white/20 text-gray-700 hover:bg-emerald-600 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl"
